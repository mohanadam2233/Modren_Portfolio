      ...
      <div className={`grid md:grid-cols-2 items-center gap-8 ${glass} rounded-3xl p-6 md:p-10 shadow-xl`}> 
        ...
        >
          <div className="relative">
            ...
            <img
              src="https://plus.unsplash.com/premium_photo-1682096252599-e8536cd97d2b?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
              alt="Profile"
